...
@Stateless
public class TempoGestacaoResource {
...
// VARIABLES_RESOURCE
	...
	public Response getById(Integer id, @Context HttpHeaders headers){
		...
		TempoGestacao entidade = tempoGestacaoBusiness.findById(id);
	...
	public Response getAll(@Context HttpHeaders headers){
		...
		List<TempoGestacao> list = tempoGestacaoBusiness.findAll();
	...
	public Response getAllFast(@Context HttpHeaders headers){
		...
		List<TempoGestacao> list = tempoGestacaoBusiness.findAllFast();
	...
	public Response getAll(Integer page, @Context HttpHeaders headers){
		...
		List<TempoGestacao> list = tempoGestacaoBusiness.findAll(page);
	...
	public Response getByExample(String json, @Context HttpHeaders headers){
		...
		TempoGestacao example = gson.fromJson(json, TempoGestacao.class);
		List<TempoGestacao> list = tempoGestacaoBusiness.findByExample(example,example.getListPage(),example.getListPageSize());
	...
	public Response create(String json, @Context HttpHeaders headers){	
		...
		TempoGestacao entidade = gson.fromJson(json, TempoGestacao.class);
		entidade.setDataCadastro(new Date());
		entidade.setUsuarioCadastro(usuario);
		
		try {
			entidade = tempoGestacaoBusiness.create(entidade);			
		} catch (Exception e) {			
			e.printStackTrace();
		}
	...
	public Response update(String json, @Context HttpHeaders headers){	
		...
		try {
			entidade = tempoGestacaoBusiness.update(entidade);
		} catch (Exception e) {			
			e.printStackTrace();
		}
	...
	public Response listagem(String json, @Context HttpHeaders headers){
		...
		TempoGestacao example = gson.fromJson(json, TempoGestacao.class);
		List<TempoGestacao> list = tempoGestacaoBusiness.findByExample(example);

		byte[] bytesReport = null;
		try {
			bytesReport = tempoGestacaoBusiness.listagemPDF(this.httpServletResquest, usuario, list);
		...
		return Response.ok(bytesReport).header("Access-Control-Allow-Origin", frontEndResponse)
				...
				.header("Content-Disposition", "filename=\"" + "tempoGestacaoList" + ".pdf\"").build();
	}
