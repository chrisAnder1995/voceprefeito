...
import com.devidea.data.repository.DrogaRepository;
...
@Stateless
public class DrogaController implements DrogaBusiness{
	...
	public Droga create(Droga entity) {
		...
		entity = drogaRepository.create(entity);
	...
	public Droga update(Droga entity) {
		...
		entity = drogaRepository.update(entity);
	...
	public List<Droga> findAll(Integer page) {
		return drogaRepository.findAll(page);
	}
	...
	@Override
	public byte[] listagemPDF(HttpServletRequest httpServletResquest, Usuario usuario, List<Droga> drogaList)
			throws JRException, IOException {
		byte[] reportBytes = null;
		
		if(drogaList != null) {	
			
			String reportName = "drogaList";
			...
			JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(drogaList);
	...
	public List<Droga> findByExample(Droga example, Integer... page) {
		return drogaRepository.findByExample(example, page);
	}
