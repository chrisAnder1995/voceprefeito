...
@Stateless
public class MotivoSolicitacaoController implements MotivoSolicitacaoBusiness{
	
	@EJB
	private MotivoSolicitacaoRepository motivoSolicitacaoRepository;
	...
	public MotivoSolicitacao create(MotivoSolicitacao entity) {
		...
		entity = motivoSolicitacaoRepository.create(entity);
	...
	public MotivoSolicitacao update(MotivoSolicitacao entity) {
		...
		entity = motivoSolicitacaoRepository.update(entity);
	...
	public MotivoSolicitacao findById(Integer id) {
		return motivoSolicitacaoRepository.findById(id);
	}

	@Override
	public List<MotivoSolicitacao> findAll() {
		return motivoSolicitacaoRepository.findAll();
	}

	@Override
	public List<MotivoSolicitacao> findAll(Integer page) {
		return motivoSolicitacaoRepository.findAll(page);
	}
	...
	@Override
	public byte[] listagemPDF(HttpServletRequest httpServletResquest, Usuario usuario, List<MotivoSolicitacao> motivoSolicitacaoList)
			throws JRException, IOException {
		byte[] reportBytes = null;
		
		if(motivoSolicitacaoList != null) {	
			
			String reportName = "motivoSolicitacaoList";
			...
			JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(motivoSolicitacaoList);
	...
	public List<MotivoSolicitacao> findByExample(MotivoSolicitacao example, Integer... page) {
		return motivoSolicitacaoRepository.findByExample(example, page);
	}
