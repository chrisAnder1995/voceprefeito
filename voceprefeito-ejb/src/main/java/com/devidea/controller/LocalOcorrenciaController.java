...
@Stateless
public class LocalOcorrenciaController implements LocalOcorrenciaBusiness{
	
	@EJB
	private LocalOcorrenciaRepository localOcorrenciaRepository;
	...
	public LocalOcorrencia create(LocalOcorrencia entity) {
		...
		entity = localOcorrenciaRepository.create(entity);
	...
	public LocalOcorrencia update(LocalOcorrencia entity) {
		...
		entity = localOcorrenciaRepository.update(entity);
	...
	public LocalOcorrencia findById(Integer id) {
		return localOcorrenciaRepository.findById(id);
	}

	@Override
	public List<LocalOcorrencia> findAll() {
		return localOcorrenciaRepository.findAll();
	}

	@Override
	public List<LocalOcorrencia> findAll(Integer page) {
		return localOcorrenciaRepository.findAll(page);
	}
	...
	@Override
	public byte[] listagemPDF(HttpServletRequest httpServletResquest, Usuario usuario, List<LocalOcorrencia> localOcorrenciaList)
			throws JRException, IOException {
		byte[] reportBytes = null;
		
		if(localOcorrenciaList != null) {	
			
			String reportName = "localOcorrenciaList";
			...
			JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(localOcorrenciaList);
	...
	public List<LocalOcorrencia> findByExample(LocalOcorrencia example, Integer... page) {
		return localOcorrenciaRepository.findByExample(example, page);
	}
