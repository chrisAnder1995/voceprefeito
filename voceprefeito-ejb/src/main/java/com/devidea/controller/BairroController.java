...
@Stateless
public class BairroController implements BairroBusiness{
	...
	public Bairro create(Bairro entity) {
		...
		entity = bairroRepository.create(entity);
	...
	public Bairro update(Bairro entity) {
		...
		entity = bairroRepository.update(entity);
	...
	public List<Bairro> findAll(Integer page) {
		return bairroRepository.findAll(page);
	}

	@Override
	public List<Bairro> findAllFast() {
		return bairroRepository.findAllFast();
	}

	@Override
	public byte[] listagemPDF(HttpServletRequest httpServletResquest, Usuario usuario, List<Bairro> bairroList)
			throws JRException, IOException {
		byte[] reportBytes = null;
		
		if(bairroList != null) {	
			
			String reportName = "bairroList";
			...
			JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(bairroList);
	...
	public List<Bairro> findByExample(Bairro example, Integer... page) {
		return bairroRepository.findByExample(example, page);
	}
