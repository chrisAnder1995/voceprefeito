...
@Stateless
public class OcorrenciaController implements OcorrenciaBusiness{
	...
	public Ocorrencia create(Ocorrencia entity) {
		...
		entity = ocorrenciaRepository.create(entity);
	...
	public Ocorrencia update(Ocorrencia entity) {
		...
		entity = ocorrenciaRepository.update(entity);
	...
	@Override
	public byte[] listagemPDF(HttpServletRequest httpServletResquest, Usuario usuario, List<Ocorrencia> ocorrenciaList)
			throws JRException, IOException {
		byte[] reportBytes = null;
		
		if(ocorrenciaList != null) {	
			
			String reportName = "ocorrenciaList";
			...
			JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(ocorrenciaList);
	...
	public List<Ocorrencia> findByExample(Ocorrencia example, Integer... page) {
		return ocorrenciaRepository.findByExample(example, page);
	}
