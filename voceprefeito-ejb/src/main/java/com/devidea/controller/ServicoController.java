...
@Stateless
public class ServicoController implements ServicoBusiness{
	...
	public Servico create(Servico entity) {
		...
		entity = servicoRepository.create(entity);
	...
	public Servico update(Servico entity) {
		...
		entity = servicoRepository.update(entity);
	...
	@Override
	public byte[] listagemPDF(HttpServletRequest httpServletResquest, Usuario usuario, List<Servico> servicoList)
			throws JRException, IOException {
		byte[] reportBytes = null;
		
		if(servicoList != null) {	
			
			String reportName = "servicoList";
			...
			JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(servicoList);
	...
	public List<Servico> findByExample(Servico example, Integer... page) {
		return servicoRepository.findByExample(example, page);
	}
