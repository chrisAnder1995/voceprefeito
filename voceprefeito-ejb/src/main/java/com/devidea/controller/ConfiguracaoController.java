...
@Stateless
public class ConfiguracaoController implements ConfiguracaoBusiness{
	...
	public Configuracao create(Configuracao entity) {
		...
		entity = configuracaoRepository.create(entity);
	...
	public Configuracao update(Configuracao entity) {
		...
		entity = configuracaoRepository.update(entity);
	...
	public List<Configuracao> findAll(Integer page) {
		return configuracaoRepository.findAll(page);
	}
	...
	@Override
	public byte[] listagemPDF(HttpServletRequest httpServletResquest, Usuario usuario, List<Configuracao> configuracaoList)
			throws JRException, IOException {
		byte[] reportBytes = null;
		
		if(configuracaoList != null) {	
			
			String reportName = "configuracaoList";
			...
			JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(configuracaoList);
	...
	public List<Configuracao> findByExample(Configuracao example, Integer... page) {
		return configuracaoRepository.findByExample(example, page);
	}
