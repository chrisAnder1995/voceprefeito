...
@Stateless
public class UsuarioController implements UsuarioBusiness{
	...
	public List<Usuario> findAllFast() {
		return usuarioRepository.findAllFast();
	}

	@Override
	public Usuario update(Usuario entity) throws IOException {
		if (entity.getImagem() != null && entity.getImagem().getBase64() != null && entity.getImagem().getBase64() != "") {
			Imagem image = entity.getImagem();
			image.setData(new Date());
			image = imagemBusiness.update(image);
			entity.setImagem(image);
		}
	...
	public Usuario login(String email, String password) {
		return usuarioRepository.find(email, password);
	}
	...
	public List<Usuario> findByExample(Usuario example, Integer... page) {
		return usuarioRepository.findByExample(example, page);
	}

	@Override
	public void preCadastro(String classe, String sequence, String nome) {
		usuarioRepository.preCadastro(classe,sequence,nome);
	}

	@Override
	public List<Usuario> consultarUsuario(Usuario entity) {
		return usuarioRepository.consultarUsuario(entity);
	}
